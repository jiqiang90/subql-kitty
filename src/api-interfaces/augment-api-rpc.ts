...
import type { KittyIndex } from 'kitty-birthinfo/api-interfaces/kitties';
...
declare module '@polkadot/rpc-core/types.jsonrpc' {
  export interface RpcInterface {
    ...
    kitties: {
       ...
       * Get Kitty price
       **/
      getKittyPrice: AugmentedRpc<(at: BlockHash | string | Uint8Array, kittyIndex: KittyIndex | AnyNumber | Uint8Array) => Observable<Balance>>;
    };
    mmr: {
      /**
